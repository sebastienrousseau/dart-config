...
This document describes how @sebastienrousseau/dart-config is run: who decides what, how
...
@sebastienrousseau/dart-config is **maintainer-led**. As of the current release line it has a single
