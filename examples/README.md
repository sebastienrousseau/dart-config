# `@sebastienrousseau/dart-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/dart-config`.
...
- [x] **analysis_options.yaml**: Standardized rule preset
