...
%global npm_bare      dart-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-dart-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Dart / Flutter configuration providing standardized analysis options and linter rules adhering to modern 2026 standards

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/dart-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/dart-config is a shareable configuration preset with no runtime
...
install -pm 0644 analysis_options.yaml %{buildroot}%{sitelib}/%{npm_scope}/%{npm_bare}/
