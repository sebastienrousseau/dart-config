...
lp=lm?'/dart-config/'+lm[1]:'/dart-config';
function load(){if(idx)return Promise.resolve();var sp=lm?'/dart-config/'+lm[1]+'/search-index.json':'/dart-config/search-index.json';return fetch(sp).then(function(r){return r.json()}).then(function(d){idx=d.entries||[]}).catch(function(){idx=[]})}
